<H4> comando para gerar o conteiner docker para RaabbitMQ com network :<H4>  docker run -it --name rabbitmq -p 5672:5672 -p 15672:15672 --network projeto-fila-network rabbitmq:4.0-management
